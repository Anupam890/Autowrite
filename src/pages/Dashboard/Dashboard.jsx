...
const Dashboard = () => {
  ...
  return (
    <>
      <div className="container h-screen min-w-full flex relative">
        {/* Left Sidebar */}
        <div
          className={`left bg-white border-r-2 h-screen fixed z-10 transform ${
          ...
          <div className="nav-container h-[calc(100%-4rem)] p-4">
            <div className="nav-item">
              <div>
                ...
                <ul>
                  <li className="flex items-center gap-4 py-2 px-4 rounded-md hover:bg-[#6041FF] hover:text-white">
        ...
        <div className="right w-full h-full flex-1">
          <div className="dashboard-nav h-20 w-full flex items-center justify-between px-4 border-b-2">
            ...
            <div className="flex items-center gap-4">
              <div className="theme">
                {
                  darkMode ? <FaMoon onClick={handleTheme} className="text-2xl cursor-pointer "/> : <FaRegSun onClick={handleTheme} className="text-2xl cursor-pointer"/>
                }
              </div>
